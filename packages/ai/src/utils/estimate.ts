import type { AssistantMessage, Context, Message, PromptContentBlock, Tool, Usage } from "../types.ts";
...
const ESTIMATED_DOCUMENT_CHARS = 12000;
...
function estimateTextAndImageContentChars(content: string | PromptContentBlock[]): number {
	...
	for (const block of content) {
		...
		else chars += ESTIMATED_DOCUMENT_CHARS;
	}
	return chars;
}
...
export function estimateTextAndImageContentTokens(content: string | PromptContentBlock[]): number {
