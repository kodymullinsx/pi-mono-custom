...
description: "Comprehensive fieldwork execution guidance for IAD audits covering control testing procedures, walkthrough documentation, attribute testing, technical controls validation (code/script/database testing), population and sampling, supplemental questions, TOE (Test of Operating Effectiveness) 8-question framework, issue validation workpapers, detailed testing tables (DTT), conclusions, and summary memos. Use when executing audit fieldwork for developing and testing RCM controls, documenting system walkthroughs, performing attribute testing, testing technical controls (automated scripts, code inspection, database connections, interfaces, Alteryx workflows), documenting population and sampling, completing supplemental questions, writing TOE documentation (including N/A language for automated controls), writing test conclusions, developing audit summary memos, building issue validation workpapers (action plan validation, remediation testing, TOD/TOE attribute structure, OE population and sampling for non-recurring remediations, Design Evaluation and Operating Effectiveness Evaluation sections), or creating detailed testing tables (DTT format with header block, attribute key, sample rows with tickmark columns, legend, conciseness rules, and examples for recurring controls, automated controls, and issue validations). Supports manual, automated, ITDM, interface, and monitoring controls across all audit phases from fieldwork through reporting."
---
