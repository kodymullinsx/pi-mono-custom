"""Pack an unpacked OOXML directory into a DOCX, PPTX, XLSX, XLSM, XLTX, or XLTM file.
...
OOXML_OUTPUT_EXTENSIONS = {".docx", ".pptx", ".xlsx", ".xlsm", ".xltx", ".xltm"}
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "output_file",
        help="Output Office file (.docx/.pptx/.xlsx/.xlsm/.xltx/.xltm)",
    )
